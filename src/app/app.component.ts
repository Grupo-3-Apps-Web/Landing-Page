...
import { AboutTeamPageComponent } from './automovil-unite/pages/about-team-page/about-team-page.component';
...
@Component({
  selector: 'app-root',
  imports: [TranslateModule, HomePageComponent, NavbarComponent, FunctionalitiesPageComponent, FooterComponent, DownloadPageComponent, PopularCarsPageComponent, BenefitsPageComponent, TestimonialsPageComponent, AboutTeamPageComponent],
